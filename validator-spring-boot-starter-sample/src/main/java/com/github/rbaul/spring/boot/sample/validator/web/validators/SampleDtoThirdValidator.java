...
@Slf4j
@Component
public class SampleDtoThirdValidator implements Validator, ValidationGroups.Group1 {
    @Override
    ...
    public void validate(Object target, Errors errors) {
        ValidationUtils.rejectIfEmpty(errors, "description", "validator.sampleDto.description.empty");
    }
}
